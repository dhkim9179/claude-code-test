...
-- 회원별 유형 조회 성능 향상을 위한 복합 인덱스 (findByMemberIdAndType 쿼리 최적화)
CREATE INDEX IF NOT EXISTS IDX_MILEAGE_HISTORY_MEMBER_TYPE_DATE
    ON MILEAGE_HISTORY(MILEAGE_MEMBER_ID, TYPE, CREATE_DATE);
